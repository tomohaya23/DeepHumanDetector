...
class Backbone(nn.Module):
    ...
    def __init__(self, hidden_ch, block_ch, n_stack, ids):
        ...
        self.stage1 = nn.Sequential(
            CBS(3, hidden_ch, 3, 1),
            CBS(hidden_ch, hidden_ch * 2, 3, 2),
            CBS(hidden_ch * 2, hidden_ch * 2, 3, 1),
        )
        self.stage2 = nn.Sequential(
            CBS(hidden_ch * 2, hidden_ch * 4, 3, 2),
            ELAN(hidden_ch * 4, block_ch * 2, hidden_ch * 8, n_stack=n_stack, ids=ids),
        )
        self.stage3 = nn.Sequential(
            MP(),
            ELAN(hidden_ch * 8, block_ch * 4, hidden_ch * 16, n_stack=n_stack, ids=ids),
        )
        self.stage4 = nn.Sequential(
            MP(),
            ELAN(hidden_ch * 16, block_ch * 8, hidden_ch * 32, n_stack=n_stack, ids=ids),
        )
        self.stage5 = nn.Sequential(
            MP(),
            ELAN(hidden_ch * 32, block_ch * 8, hidden_ch * 32, n_stack=n_stack, ids=ids),
        )
...
class Neck(nn.Module):
    ...
    def __init__(self, hidden_ch, panet_ch, n_stack, ids):
        ...
        self.conv_for_c4 = CBS(hidden_ch * 32, hidden_ch * 8)
        ...
        self.conv_for_c3 = CBS(hidden_ch * 16, hidden_ch * 4)
